    ...
    while True:
        ...
        if ans != "Y" and ans != "y":
            ...
            if currentfuel >= fuleAll:
                ...
                if ans == "Y" or ans == "y":
                    ueserwanttoaddfuel = float(input(f"please enter the oil quantity(Current amount of money available for refueling: {float(currentamount) / float(fromAirportFuelPrice[0][2])} L): "))
